...
//         id: `${schedule._id}-${index}`,
//         group: schedule.subjectId._id || schedule.subjectId,
//         title: `D-${index + 1}`, // Reverted to D-1, D-2, etc.
//         start_time: start,
//         end_time: end,
//         canMove: false,
//         canResize: false,
...
//           <button
//             onClick={handleMoveLeft}
//             className="px-2 py-2 bg-indigo-600 text-white rounded-md shadow hover:bg-indigo-700 transition duration-200"
//           >
//             ← Move Left
//           </button>
//           <button
...
//                 style={{
//                   overflowX: "hidden",
//                   marginLeft: sidebarMinimized ? "0" : "20px",
